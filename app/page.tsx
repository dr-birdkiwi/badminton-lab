...
const references: Record<ReferenceKey, Reference> = {
  synergy: { label: '肌肉协同', kind: '研究', href: 'https://www.frontiersin.org/journals/sports-and-active-living/articles/10.3389/fspor.2025.1596670/full', title: '2025 年精英羽毛球运动员上肢肌肉协同研究' },
  xfactor: { label: '躯干旋转', kind: '研究', href: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC5260572/', title: '羽毛球杀球中的躯干旋转与肩带运动研究' },
  shoulder: { label: '肩内旋与拍速', kind: '研究', href: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC6016291/', title: '肩部力量与羽毛球拍速度关系研究' },
  jumpSmash: { label: '跳杀研究', kind: '研究', href: 'https://pubmed.ncbi.nlm.nih.gov/33663330/', title: '精英羽毛球跳杀的运动学决定因素研究' },
  impact: { label: '触球位置', kind: '研究', href: 'https://oars.uos.ac.uk/1325/1/Effect%20of%20racket-shuttlecock%20impact%20location.pdf', title: '国际水平羽毛球杀球中的拍—球碰撞位置研究' },
  lowerLimb: { label: '下肢研究', kind: '研究', href: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC9598458/', title: '羽毛球过顶动作中的下肢运动学与地面反作用力研究' },
  plyometric: { label: '增强式训练', kind: '综述', href: 'https://pubmed.ncbi.nlm.nih.gov/38533062/', title: '羽毛球增强式训练效果的系统综述与荟萃分析' },
  upperSynergy: { label: '上肢协同', kind: '研究', href: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC6317092/', title: '羽毛球击球中的上肢肌肉协同研究' },
  racket: { label: '球拍参数', kind: '研究', href: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC10462755/', title: '球拍惯量对拍头速度、触球位置与出球速度的影响研究' },
  bwf: { label: 'BWF 教练手册', kind: '教练资料', href: 'https://sfbadminton.tenniscity.org/wp-content/uploads/sites/29/2020/03/bwf_coach_education_coaches_manual_l1-2nd-edition-midres.pdf', title: 'BWF 教练教育手册（杀球与击球技术）' },
};
...
const lessonSteps: LessonStep[] = [
  ...
  },
  {
    ...
    action: '作为场上观察线索，检查拍头是否在触球前形成清晰加速，并观察肩部、肘部、前臂和手部是否在一段连续动作中共同参与，而不是用动作幅度或孤立甩腕解释拍速。研究没有证明所有球员都必须使用完全相同的分段时序。',
    cue: '触球前能看到拍头逐步加速，身体没有提前僵住；拍速提升没有明显牺牲触球质量。',
...
const principleSequence: PrincipleSequenceStep[] = [
  ...
  { number: '03', label: '上肢形成拍头速度', title: '让肩、肘、前臂和手部动作共同参与挥拍', text: '肩部、肘部、前臂和手部动作在连续动作中共同参与拍头速度与方向的形成；研究观察到的是协调关系，不是每名球员完全相同的分段时序。', alt: '羽毛球击球前拍头加速阶段', refs: ['shoulder', 'synergy', 'upperSynergy'] },
...
const forceNodes: ForceNode[] = [
  ...
  { number: '05', label: '肩 · 肘 · 前臂', group: '组织拍速', title: '让上肢共同形成拍头速度', action: '肩部内旋、肘部伸展、前臂旋转以及握拍和腕部调整，在连续挥拍中共同参与拍头速度与方向的形成；研究不支持用一个固定时序解释所有球员。', focus: '肩带 · 肘部 · 前臂（训练关注区域）', focusCue: '感受上肢整体加速；不要把拍速简化成“只用手臂”或孤立甩腕。', principle: '研究支持多关节、多肌群协同，不支持把拍速归功于单一关节或单一肌肉。', cue: '拍头在触球附近形成有效速度；不主动把肘锁死，上臂也不必过度耸高。', image: 'force-action-05.png', imageAlt: '羽毛球击球前肩肘前臂协同加速动作', refs: ['synergy', 'shoulder', 'jumpSmash'] },
  ...
  return (
    <main className="force-site">
      ...
      <section id="lesson" className="lesson-section force-section">
        ...
        <div className="lesson-intro"><p>本站用一组真实回合作为验收，记录四个结果指标：击球窗口、拍头速度、触球位置与拍面控制、下一拍准备。关于拍头速度与触球位置的研究，可帮助理解前两类结果；下一拍准备是本站的场上验收指标。哪一项先丢，就回到对应训练，不用继续加力补救。<InlineReferences refs={['jumpSmash', 'impact']} /></p><strong>动作可以不同，结果必须可复现。</strong></div>
      ...
      <section id="boundary" className="boundary-section force-section">
        ...
        <p className="reference-disclaimer">页面内的链接只支持其相邻文字中标明的研究事实；动作口令、击球分类、训练任务和剂量是本站基于证据的教学转译或实践模板，不代表论文逐字验证了每一句话。训练模块后的链接只说明相关能力或结果，不等于该练法本身已经被直接验证。BWF 手册属于教练教育资料，不等同于同行评审研究。</p>
