...
const lessonSteps: LessonStep[] = [
  {
    ...
    label: '窗口',
    title: '触球窗口是否还在身前、上方？',
    action: '这是本站的场上观察线索，不是固定高度标准：看触球前，球是否仍有机会落在持拍肩前方、上方的可用空间；身体是否需要明显后仰或追到身后去补偿位置。来球、步法和击球类型会改变窗口；窗口被压缩时，改用更可控的击球选择，而不是用更大力量补救位置。',
    cue: '来球允许时，不靠明显后仰或追到身后，也能在身前完成触球。',
